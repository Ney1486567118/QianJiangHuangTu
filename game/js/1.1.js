let dialogues = [
    "初春傍晚，料峭春寒夹杂着雪雨纷纷。",
    "今日的你在学堂收获颇丰，打着小伞冒着大雨迫不及待地要将这喜悦分享给母妃。",
    "谁知刚到宫殿门口，却看见一双手将母妃推入了院子的井中。",
    "你丢下伞冲了过去，那双手的主人已无影无踪，望向井底，母妃衣衫染血凌乱不堪，只余一双含着忧伤，慌乱又死不瞑目的眼，惊恐而又无神地望着你。",
    "\"母妃!\"",
    "你的喊声召来了许多宫人和婢女，在这倾盆大雨中夹杂着各种慌乱，嘈杂，恐惧的喊声和脚步声，你却如什么都感知不到一般，意识陷入了混沌之中。"
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '../html/1.2.html'; // 替换为你的目标 HTML 文件
        }
    } else {
