document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '2.16.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "长公主殿下，这是怎么了?", character: "玩家", speaker: 1 },
    { text: "哎说起来倒是我的不是，前些日子皇上赏了我和驸马一对白玉镂雕凤凰坠佩，那可是难得的珍品，但是我却不小心遗失在御花园了，这可怎么办啊。", character: "长公主", speaker: 2 },
    { text: "公主别着急，这玉佩说不定马上就找着了，且多派些人手来。", character: "玩家", speaker: 1 }
];
