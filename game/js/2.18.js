...
function updatePoints(option) {
    ...
    switch(option) {
        case '父皇，我最近也正在习读您手中的《尚书》':
            wisdom -= 10;//改改改！！！！！！！！！！！！
            break;
        case '向父皇行礼'://根据实际情况改改改！！！！
            emperor += 20;
            sixArts += 20;
            break;
         case '默默跟在大皇子二皇子身后观察他们':
                wisdom += 10;//改改改！！！！！！！！！！！！
                break;    
        default:
            break;
...
function selectOption(option) {
    ...
    switch(option) {
        case '父皇，我最近也正在习读您手中的《尚书》':
            selectedDialogue = "太子轻蔑地向你翻了个白眼：\"见了父皇也不会行礼，说话冒冒失失。\"\n智慧-10";
            nextPageUrl = "2.18.1.html"; // 改改改！
            break;
        case '向父皇行礼':
            selectedDialogue = "六艺+20——；皇帝认可度+20";
            nextPageUrl = "2.20.html"; // 改改改！
            break;
            case '默默跟在大皇子二皇子身后观察他们':
                selectedDialogue = "通过观察获得一些战略和社交技巧的启发 智慧+10";
                nextPageUrl = "2.20.html"; // 改改改！
                break;
    }
