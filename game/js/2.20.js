let dialogues = [
    "【在一片祥和的气氛中，通过父子闲聊，你隐约察觉到皇帝对每个皇子的期望各不相同。他不仅关注各个皇子的成长，更希望你们能够展现出独特的智慧和深思熟虑的策略。对话中流露出他对未来接班人的重视，你也明白了他希望能找到一个全面发展、具备深厚内涵的皇子。】",
    "【日子就这样一天天过去......】"
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '3.1.html'; // 替换为你的目标 HTML 文件
        }
    } else {
