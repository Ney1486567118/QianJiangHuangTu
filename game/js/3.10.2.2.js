let dialogues = [
    "你连夜去找皇上，希望能让皇帝做你的挡箭牌",
    "你把连日来朝中大员给他递名单，想让你在春闱科考中舞弊的事一五一十说出来，你想为这次春闱讨一份公平，可人微言轻，担心自己不能承担此事的后果，只能来找皇帝求助。",
    "皇上答应了你的请求，给了你拒绝名单的底气。\n皇帝认可度+50"
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '3.11.3.html'; // 替换为你的目标 HTML 文件
        }
    } else {
