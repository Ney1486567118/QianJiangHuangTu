document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = '3.12.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "【在母妃的建议下，你去找礼部尚书询问一些春闱的潜规则】", character: "礼部尚书", speaker: 1 },
    { text: "臣已经将春闱注意事项整理成册，殿下尽可查阅。还望殿下在陛下面前多多替臣美言几句，臣就感激不尽了。", character: "礼部尚书", speaker: 1 },
    { text: "【你仔细翻看，这册子关于春闱考场上的事情面面俱到，显然是用了心的】", character: "玩家", speaker: 2 },
    { text: "礼部尚书如此高风亮节，本王一定会在父皇面前多多美言几句。", character: "玩家", speaker: 2 }
];
