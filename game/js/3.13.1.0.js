document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = '3.14.1.0.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "【驸马帮你细细看了册子，随机不屑地笑了】\n这册子虽然完整，但是只写了春闱规则之内的禁忌，这春闱外的规则他是一字不提啊。你要真这么做，只怕会落得一个万劫不复的境地。", character: "驸马", speaker: 1 },
    { text: "还请驸马助我。我想还这世人一个朗朗的春闱环境\n【驸马详细给你提点了春闱考场内烛火，水源，阅卷糊名等在规则之下的重点关照项目，你一一记下并做了周密的安排】", character: "玩家", speaker: 2 }
];
