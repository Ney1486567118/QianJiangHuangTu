let dialogues = [
    "礼部尚书的妹妹是皇后的表妹，太子的姨母，一直负责春闱相关事宜。",
    "今年他将翻修贡院外墙的活交给那些进京赶考却贫寒的考生，想让那些家境贫穷的考试赚点钱补贴这段在京城冲刺温书的岁月。",
    "当你听到这个消息的时候，很为礼部尚书高尚的行为动容，"
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '3.5.html'; // 替换为你的目标 HTML 文件
        }
    } else {
