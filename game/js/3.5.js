...
function selectOption(option) {
    ...
    switch(option) {
        case '伪装考生来贡院工地干活，一探究竟':
            selectedDialogue = "伪装考生来贡院工地干活，一探究竟";
            nextPageUrl = "3.6.html"; // 改改改！
            break;
        case '拜访礼部尚书，希望能得到关于春闱的规则':
            selectedDialogue = "拜访礼部尚书，希望能得到关于春闱的规则";
            nextPageUrl = "3.16.html"; // 改改改！
            break;
    }
