let dialogues = [
    { text: "【你选择去尚书家一问究竟，在你的质疑下礼部尚书连连摆手】", character: "礼部尚书" },
    { text: "臣一生为官清廉，没有贪污一分钱，臣将替换下来的木头和石材都记录在册，全部都在库房里，殿下自可一探究竟。", character: "礼部尚书" },
    { text: "臣只想用翻新贡院外墙这一事做一些政绩，今天殿下不知是听了哪位学子胡言乱语，简直是一派胡言。\n", character: "礼部尚书" }
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '3.8.html'; // 替换为你的目标 HTML 文件
        }
    } else {
