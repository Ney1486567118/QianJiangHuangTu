let dialogues = [
    "【背景：随着四皇子年岁渐长，愈发伶俐可爱，皇帝对延禧宫的关照也多了些。再加上四皇子母家镇国有功，皇帝虽仍不喜熙妃的性子，对其态度也有所缓和，偶尔还会送去一些关心和赏赐。】",
    "【皇后开始忌惮熙妃，认为自己和太子的地位受到了威胁。恰逢将军进京述职，皇后动用朝中人脉，以外戚功高盖主等莫须有的罪名，成功让皇帝对熙妃之父镇国将军产生怀疑，将军府尽数下狱，熙妃亦被打入冷宫。】"
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '4.2.html'; // 替换为你的目标 HTML 文件
        }
    } else {
