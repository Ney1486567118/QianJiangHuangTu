let dialogues = [
    { text: "战报中缺失的那一页至关重要，必须找到当日负责记录战报的文书官，他可能知道当时发生了什么。", character: "玩家" },
    { text: "【你派人去寻找当日记录战报的文书官，最终找到了他。】", character: "玩家" }
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '4.13.2.1.html'; // 替换为你的目标 HTML 文件
        }
    } else {
