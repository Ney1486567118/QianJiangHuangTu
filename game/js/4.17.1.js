document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '4.17.1.1.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "（低头回应）回大人，奴婢未曾听闻娘娘有失言之举。", character: "宫女甲", speaker: 1 },
    { text: "（战战兢兢）奴婢……奴婢也是如此，只记得娘娘时常思念将军，但从未有过不敬之言。", character: "宫女乙", speaker: 2 }
];
