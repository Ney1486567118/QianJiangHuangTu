let dialogues = [
    "你发现了宫女和皇后宫中太监暗中往来的情况，你抓住那名太监进行拷问，他承认了此事是受皇后指使对熙妃的污蔑，并交出了皇后用来买通他们的证据。",
    "熙妃得以正名。不过皇后拒不承认此事，声称信物是太监所盗，二人有私情被皇后发现，遂泼脏水于皇后。当夜太监在牢里暴毙，宫女自缢而亡。"
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '4.20.html'; // 替换为你的目标 HTML 文件
        }
    } else {
