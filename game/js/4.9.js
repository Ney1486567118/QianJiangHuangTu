...
function selectOption(option) {
    ...
    switch(option) {
        case '答应他':
            selectedDialogue = "你答应了四皇子的恳求，安慰他并将他送回，着手调查事情的真相\n声望+10";
            nextPageUrl = "4.9.1.html"; // 改改改！
            break;
        case '拒绝他':
            selectedDialogue = "四皇子失宠，镇国将军一家被构陷致死，国家损失一员大将，军事实力遭受打击，你也失去了四皇子这一助力。\n声望-100";
            nextPageUrl = "4.9.2.html"; // 改改改！
            break;
    }
