let dialogues = [
    ...
    "上元佳节，皇宫中举办宴饮聚会，皇亲宗室，王公贵族都悉数到场，端是团圆阖家欢乐的美满景象。皇帝在宴席上大赞太子为国分忧，献出妙计使得准噶尔归顺。",
    "宴席上，你看见许多人向太子二哥敬酒。他意气风发，来者不拒，觥筹交错，已是面色潮红。",
    "你担心喝酒误事，正巧宫女将新斟好的酒摆在你的面前，你便带上酒壶，上前给太子倒酒庆祝。"
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '5.2.html'; // 替换为你的目标 HTML 文件
        }
    } else {
