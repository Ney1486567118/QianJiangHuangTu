...
function selectOption(option) {
    ...
    switch(option) {
        case '帮助太子皇兄':
            selectedDialogue = "帮助太子皇兄";
            nextPageUrl = "5.10.1.html"; // 改改改！
            break;
        case '冷眼旁观':
            selectedDialogue = "冷眼旁观";
            nextPageUrl = "5.10.2.html"; // 改改改！
            break;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    dialogueText.textContent = "你听过后，心里很不是滋味。显赫一世的太子在宫斗的斗争下原来也岌岌可危。【你选择】"; // 页面加载时显示初始话语
});
