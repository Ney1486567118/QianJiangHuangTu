document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = '5.12.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "儿臣没有其他的意思，只是父皇要保重龙体，千万不能因为这些事情气坏了身子。", character: "大皇子", speaker: 1 },
    { text: "朕没事，那老大，这件事就交给你，朕要查一个水落石出。", character: "皇帝", speaker: 2 },
    { text: "儿臣领命。", character: "大皇子", speaker: 1 }
];
