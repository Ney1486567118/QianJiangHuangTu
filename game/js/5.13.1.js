document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = '5.14.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "【皇上随即甩了一大叠书信到地上】\n好，好，好，朕的太子，朕什么时候不为他找想，他倒觊觎朕的江山，朕的女人了。好一个清白，原来是颠倒黑白。", character: "皇帝", speaker: 1 },
    { text: "你看了看父皇扔到地上的书信，发现竟然是太子和准噶尔来往密切的信件。", character: "玩家", speaker: 2 }
];
