...
function selectOption(option) {
    ...
    switch(option) {
        case '询问发生了什么':
            selectedDialogue = "询问发生了什么";
            nextPageUrl = "5.13.1.html"; // 改改改！
            break;
        case '默默站在一旁等皇上说话':
            selectedDialogue = "默默站在一旁等皇上说话";
            nextPageUrl = "5.13.2.html"; // 改改改！
            break;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    dialogueText.textContent = "过了几天，你被召到皇上那里。面对怒气冲冲的皇上和在其身旁站着的大皇子，【你选择】"; // 页面加载时显示初始话语
});
