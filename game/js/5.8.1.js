document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = '5.9.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "皇上......皇上......那...那是......", character: "内侍", speaker: 2},
    { text: "(生气)说个话怎么磨磨唧唧的，到底是谁?", character: "皇帝", speaker: 1 },
    { text: "是......是太子殿下，和......和准噶尔献于皇上的香妃娘娘......", character: "内侍", speaker: 2 },
    { text: "(怒火攻心)这....这....这逆子，当朕是摆设吗?怎么，原来给朕献计准噶尔和亲政策目的是为了自己的这点子破事吗? 给朕押过来。", character: "皇帝", speaker: 1 }
];
