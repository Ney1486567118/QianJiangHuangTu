let dialogues = [
    "【突然，马车下的地面裂开，隐藏的陷阱瞬间发动，马车倾覆，沈怀玉被困在车内。你率领部队从隐蔽处现身，迅速包围了马车。沈怀玉挣扎着想要逃脱，但已是徒劳。】",
    "【你的计划完美无缺，沈怀玉终于落入了你的陷阱。他的罪行被公之于众，你的智慧和勇气赢得了朝野上下的赞誉。】",
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '8.10.html'; // 替换为你的目标 HTML 文件
        }
    } else {
