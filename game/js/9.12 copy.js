document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '9.13 copy.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "父皇，今日我府上收了一名门客，最善制药。今日请他来，想给父皇献上一份他特制的延年益寿的神药。", character: "四皇子", speaker: 1 },
    { text: "（龙颜大悦）是吗，拿来让朕瞧瞧。", character: "皇帝", speaker: 2 },
    { text: "四皇子的门客献上了一份和那些术士们一样配方的药。皇上还不算太糊涂，将药送去了太医院查验。", character: "四皇子", speaker: 1 }
];
