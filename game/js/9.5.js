let dialogues = [
    "【四皇子在朝中混的如鱼得水，大皇子几次设计都被他巧妙化解，眼线也是遍布全朝。凭靠他的力量，你很快发现了端倪。】",
    "【宫中不知何时来了几个术士，搞的朝中乌烟瘴气。皇帝似乎很信任他们，据说寝殿中使用的熏香，日常滋补的药物，都是出自他们之手。而那几个术士，皆出于大皇子门下。】",
    "【而大皇子亦形迹可疑，似乎每个月圆之夜都会在欣答应的掩饰下潜入后宫，不知作何。】"
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '9.6.html'; // 替换为你的目标 HTML 文件
        }
    } else {
