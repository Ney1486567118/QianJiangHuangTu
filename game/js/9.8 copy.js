let dialogues = [
    { text: "【你以思念母亲为由申请入后宫去看了熙妃，实则调查大皇子的去向。让你震惊的是，大皇子去的方向竟是你生母惨死后荒废的庭院。】", character: "玩家" },
    { text: "【你在那个荒废的庭院里发现了一个状似皇帝的纸扎的小人和奇奇怪怪的红棕色液体画的符号，竟是邪术！】", character: "玩家" },
    { text: "大皇子竟然用我母亲曾经的庭院做这事！", character: "玩家" }
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '9.9 copy.html'; // 替换为你的目标 HTML 文件
        }
    } else {
