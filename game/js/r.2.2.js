document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            window.location.href = 'r.3.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "儿臣向父皇请教狩猎技巧", character: "玩家", speaker: 1 },
    { text: "【皇帝笑到】\n《墨子·公输》中有‘古者，善射者，得于鱼鸟之类者，皆善于测量矣’之说，若射者距猎物三十丈，发矢之速为每秒六十丈，求矢射至猎物所需之时，几何秒？", character: "皇帝", speaker: 2 }
];
