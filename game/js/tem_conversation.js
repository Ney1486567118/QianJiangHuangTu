document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '0.3.html'; // 改改改！
        }
    } else {
...
let dialogues = [
    { text: "【五感六识逐渐回归，空气中弥漫着一股药香。你积蓄力量倏然睁开双眼，眼前人影绰绰，是个温婉而忧愁的宫装女子（人物造型：昭妃）】", character: "玩家", speaker: 1 },
    { text: "【女子见你醒了，喜不自胜落下泪来，急忙拉住你的手。你朝四周望去，只见紫檀雕窗锦绣画屏，端是一副后宫绮丽光景】\n 母妃......", character: "皇帝", speaker: 2 }
];
