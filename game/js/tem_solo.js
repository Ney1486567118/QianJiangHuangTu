let dialogues = [
    { text: "【这天你在回府的路上突然有个身穿补丁的学子激动的拉住你的手 并一下子跪在你的面前】\n 大人，我是来自理工村的李序~早闻大人贤名，这是小人的文字策论，特地想向大人请求拜师，得到大人的指点。小的愿肝脑涂地，只求大人稍加指点哇~", character: "李序" }
];
...
document.querySelector('.dialogue-box').addEventListener('click', () => {
    if (isShowingFullText) {
        ...
        if (currentDialogue < dialogues.length) {
            ...
            autoSave();
            window.location.href = '1.24.html'; // 替换为你的目标 HTML 文件
        }
    } else {
